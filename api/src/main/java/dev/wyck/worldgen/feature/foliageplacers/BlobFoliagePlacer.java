...
public interface BlobFoliagePlacer extends FoliagePlacer {
    ...
    static BlobFoliagePlacer of(IntProvider radius, IntProvider offset, int height) {
        record Holder() {
            static final ConstructWireProvider<BlobFoliagePlacer> WIRE = ConstructWireProvider.construct("dev.wyck.worldgen.feature.foliageplacers.BlobFoliagePlacerImpl");
        }
